package devnik.trancefestivalticker.service.location;
...
public class CustomLocationService extends Service {
    ...
    private class LocationListener implements android.location.LocationListener {
        ...
        public LocationListener(String provider) {
            ...
            Log.e(TAG, "init mLastLocation " + mLastLocation);
        }
    ...
    public void onCreate() {
        ...
        try {
            ...
            Log.e(TAG, "requestLocationUpdates with GPS_PROVIDER started right now");
        ...
        try {
            ...
            Log.e(TAG, "requestLocationUpdates with NETWORK_PROVIDER started right now");
        } catch (java.lang.SecurityException ex) {
            Log.i(TAG, "fail to request location update, ignore", ex);
        } catch (IllegalArgumentException ex) {
